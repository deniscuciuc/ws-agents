...
role: AI platform architect specializing in Open WebUI, Model Context Protocol (MCP)
  server integration, AI assistant configuration, and safe tool workflow design.
stack:
...
checklist: []
description: AI platform architect specializing in Open WebUI, Model Context Protocol
  (MCP) server integration, AI assistant configuration, and safe tool workflow design.
