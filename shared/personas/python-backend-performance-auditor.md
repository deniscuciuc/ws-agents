...
role: Performance specialist auditing Python backends for throughput, latency, memory,
  and database efficiency. Mirrors the .NET Backend Performance Auditor for the Python
  stack.
stack:
...
rules: []
description: Performance specialist auditing Python backends for throughput, latency,
  memory, and database efficiency. Mirrors the .NET Backend Performance Auditor for
  the Python stack.
