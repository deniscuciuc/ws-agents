...
description: "Security-focused frontend reviewer auditing React/TypeScript applications for client-side vulnerabilities, XSS risks, dependency issues, and insecure data handling."
tools:
  - grep
  - view
  - edit
