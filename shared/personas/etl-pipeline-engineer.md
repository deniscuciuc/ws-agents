...
role: Data platform engineer specializing in ETL/ELT pipeline design, data ingestion,
  transformation, and analytics consumption. Owns the complete data flow from source
  systems through transformation to analytics.
stack:
...
description: Data platform engineer specializing in ETL/ELT pipeline design, data
  ingestion, transformation, and analytics consumption. Owns the complete data flow
  from source systems through transformation to analytics.
