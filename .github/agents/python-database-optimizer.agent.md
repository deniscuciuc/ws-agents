...
description: "Senior database optimization specialist for Python services using PostgreSQL. Audits, optimizes, and architects database interaction layers including ORM queries, connection pooling, caching, and migration strategies."
