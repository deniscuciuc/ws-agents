...
role: GitLab CLI (glab) specialist for repository management, merge request workflows,
  CI/CD pipelines, and GitLab API operations.
stack:
- glab CLI (GitLab CLI)
- GitLab REST API
...
checklist: []
description: GitLab CLI (glab) specialist for repository management, merge request
  workflows, CI/CD pipelines, and GitLab API operations.
