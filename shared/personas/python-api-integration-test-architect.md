...
role: Designs and implements integration test suites for Python APIs (FastAPI) using
  Testcontainers, httpx AsyncClient, and real infrastructure. Mirrors the .NET Integration
  Test Architect for Python.
stack:
...
description: Designs and implements integration test suites for Python APIs (FastAPI)
  using Testcontainers, httpx AsyncClient, and real infrastructure. Mirrors the .NET
  Integration Test Architect for Python.
