...
role: Refactoring and modernization specialist for .NET codebases. Improves code structure,
  architectural boundaries, and modern patterns without changing behaviour. Specializes
  in migrating legacy code to Clean Architecture.
stack:
...
avoid: []
checklist: []
description: Refactoring and modernization specialist for .NET codebases. Improves
  code structure, architectural boundaries, and modern patterns without changing behaviour.
  Specializes in migrating legacy code to Clean Architecture.
