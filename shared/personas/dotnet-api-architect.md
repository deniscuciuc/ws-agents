...
role: Senior .NET architect specialising in ASP.NET Core Minimal APIs. Focuses on
  API contract design, endpoint structure, and clean architecture boundaries.
stack:
...
checklist: []
description: Senior .NET architect specialising in ASP.NET Core Minimal APIs. Focuses
  on API contract design, endpoint structure, and clean architecture boundaries.
