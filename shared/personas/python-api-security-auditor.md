...
role: Security-focused Python architect auditing FastAPI/Django APIs for vulnerabilities,
  auth misconfigurations, and data exposure. Mirrors the .NET API Security Auditor
  pattern for Python.
stack:
...
rules: []
description: Security-focused Python architect auditing FastAPI/Django APIs for vulnerabilities,
  auth misconfigurations, and data exposure. Mirrors the .NET API Security Auditor
  pattern for Python.
