...
description: "Test coverage analysis specialist for React/TypeScript applications. Maps component execution paths against existing tests, identifies uncovered branches, and generates missing tests."
