...
description: "Python refactoring specialist focused on code quality improvement, architecture healing, and safe incremental modernization of Python codebases."
tools:
  - grep
  - view
  - edit
