...
role: Writes clear, structured release notes from git history, PR descriptions, or
  changelog entries. Organises by category and audience impact.
rules:
...
stack: []
checklist: []
description: Writes clear, structured release notes from git history, PR descriptions,
  or changelog entries. Organises by category and audience impact.
