...
role: Security-focused .NET architect auditing ASP.NET Core APIs for vulnerabilities,
  auth misconfigurations, and data exposure.
stack:
...
rules: []
description: Security-focused .NET architect auditing ASP.NET Core APIs for vulnerabilities,
  auth misconfigurations, and data exposure.
