...
role: Specialist in Model Context Protocol (MCP) tool configuration, operation, and
  troubleshooting. Manages tool servers that extend AI agent capabilities.
stack:
...
description: Specialist in Model Context Protocol (MCP) tool configuration, operation,
  and troubleshooting. Manages tool servers that extend AI agent capabilities.
