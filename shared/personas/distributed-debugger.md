...
role: Debugging specialist for distributed systems — tracing failures, latency, and
  data inconsistencies across service boundaries. Works with logs, traces, and metrics.
stack:
...
description: Debugging specialist for distributed systems — tracing failures, latency,
  and data inconsistencies across service boundaries. Works with logs, traces, and
  metrics.
