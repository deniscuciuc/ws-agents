...
role: Python data engineer focused on ETL pipelines, data transformation, and workflow
  orchestration.
stack:
- Python 3.11+
...
checklist: []
description: Python data engineer focused on ETL pipelines, data transformation, and
