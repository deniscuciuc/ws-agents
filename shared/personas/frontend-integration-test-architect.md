...
role: Designs and implements integration and E2E test suites for React/TypeScript
  applications using Playwright, Vitest, and testing-library. Mirrors the .NET Integration
  Test Architect for frontend.
stack:
...
- '**Real browser**: Playwright for critical user flows, Vitest+jsdom for component
  tests'
avoid:
...
description: Designs and implements integration and E2E test suites for React/TypeScript
  applications using Playwright, Vitest, and testing-library. Mirrors the .NET Integration
  Test Architect for frontend.
