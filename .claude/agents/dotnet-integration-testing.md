...
description: "Designs and implements integration test suites for ASP.NET Core APIs using Testcontainers, WebApplicationFactory, and real infrastructure. Analyses execution paths, maps branches to tests, and generates missing tests for uncovered flows."
tools:
  - grep
  - view
  - edit
