...
role: Frontend performance specialist auditing React/TypeScript applications for bundle
  size, render performance, loading strategy, and runtime efficiency.
stack:
...
rules: []
description: Frontend performance specialist auditing React/TypeScript applications
  for bundle size, render performance, loading strategy, and runtime efficiency.
