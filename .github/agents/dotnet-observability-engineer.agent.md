...
description: "Designs and implements observability strategy for .NET applications: structured logging, Prometheus-compatible metrics, OpenTelemetry distributed tracing, and production diagnostics."
